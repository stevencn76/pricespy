package net.ojava.openkit.pricespy.res;
...
public class Resource {
	...
	public static final String KEY_LABEL_QUERYPRICE = "LABEL.QUERYPRICE";
	public static final String KEY_LABEL_COMPAREPRICE = "LABEL.COMPAREPRICE";
	public static final String KEY_LABEL_SYNCPRODUCT = "LABEL.SYNCPRODUCT";
...
//		"/res/main_icon128.png"
	...
	private Resource() {
		...
		try {
			...
			if(!dir.exists())
				dir.mkdir();
			File appDir = new File(dir, "pricespy");
			if(!appDir.exists())
				appDir.mkdir();
			...
			File imgDir = new File(appDir, "imgs");
			if(!imgDir.exists())
				imgDir.mkdir();
			imgPath = imgDir;
